 ...
 while (true) {
    ...
    while (true) {
      ...
      if (studentFatherName.isNotEmpty) {
        (newAdmissionStudentData.last[studentId])
            .add({'student father Name': studentFatherName});
        break;
      } else {
        print('--:  You did not enter father name correctly   :--');
      }
